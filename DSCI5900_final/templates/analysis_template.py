"""
Vibe Retail Capstone — Python Analysis Template
...
def build_sales_detail(
    ...
    TODO: Verify join keys and add profit column.
    """
...
def revenue_by_store(df: pd.DataFrame) -> pd.DataFrame:
    """TODO: aggregate total_amount and quantity by store_location."""
    return (
...
def quantity_by_product(df: pd.DataFrame) -> pd.DataFrame:
    """TODO: aggregate quantity by product_name."""
    return (
